...
# complete.cases() - 
#Shows Rows which have no missing values as TRUE and other as FALSE
complete.cases(df)
...
df_titanic <- read.csv(file = "Data/TitanicDataMissingValues.csv")
...
#there is some problem with following commented part
#removes rows with missing values in 'Fare' column
#df_titanic_drop <-df_titanic['Fare'] %>% na.omit()
#dim(df_titanic_drop)
#summary(df_titanic_drop)
