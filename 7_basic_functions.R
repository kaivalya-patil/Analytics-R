...
View(mtcars) # View()- View dataset in seperate tab like excel.
...
attributes(mtcars) #col and rownames and class
...
tail(mtcars,n=4) #bottom 4 rows

dim(mtcars)  #dimensions of DF 32 rows, 11 columns
NROW(mtcars) #number of rows  
length(mtcars) #variables nos/number of columns
